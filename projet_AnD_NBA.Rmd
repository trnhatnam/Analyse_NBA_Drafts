...
##ACP Pour une étude d'ACP, on va d'abord chercher à normaliser les données pour éviter que les grandes variances influencent les données. On va aussi prendre seulement les données qui nous intéressent
